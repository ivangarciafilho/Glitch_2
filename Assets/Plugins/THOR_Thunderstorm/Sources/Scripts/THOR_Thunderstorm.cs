...
namespace THOR
{
    public class THOR_Thunderstorm : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            string rpName = "Null";
            if (GraphicsSettings.defaultRenderPipeline != null) rpName = GraphicsSettings.defaultRenderPipeline.GetType().FullName;
            usesHDRP = rpName.Contains("HD") || rpName.Contains("HighDefinition");
        } //========================================================================================
