...
public class ScrollRectAutoScroll : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void InputScroll()
    {
        if (m_Selectables.Count > 0)
        {
            ...
            // if (rePlayer.GetAxis("Horizontal") != 0.0f || rePlayer.GetAxis("Vertical") != 0f 
            //     || rePlayer.GetAxis("UIVertical") !=  0.0f || rePlayer.GetAxis("UIHorizontal") != 0.0f)
            //     // || Input.GetButtonDown("UIHorizontal") || Input.GetButtonDown("UIVertical") 
            //     // || Input.GetButton("UIHorizontal") || Input.GetButton("UIVertical"))
            // {
