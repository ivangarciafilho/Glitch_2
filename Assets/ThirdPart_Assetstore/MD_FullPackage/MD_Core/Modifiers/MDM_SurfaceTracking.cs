...
namespace MDPackage.Modifiers
{
    ...
    /// Surface Tracking allows user to create tracks & footprints in a quick & simple way. It requires a specific shader 'Lite Mesh Tracker' shader.Runs purely on the GPU.
    /// Written by Matej Vanco, 2016
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Modifiers/Surface Tracking GPU")]
