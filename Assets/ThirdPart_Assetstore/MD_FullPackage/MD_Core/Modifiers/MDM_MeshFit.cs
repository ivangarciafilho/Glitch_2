...
namespace MDPackage.Modifiers
{
    ...
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Modifiers/Mesh Fit")]
    public sealed class MDM_MeshFit : MD_ModifierBase
    {
        ...
        public void MeshFit_GeneratePoints()
        {
            ...
            // Generating points
            Material pMat = new Material(Utilities.MD_Utilities.Specific.GetProperPipelineDefaultShader());
