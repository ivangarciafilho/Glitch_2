...
namespace MDPackage.Geometry
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Geometry/Torus")]
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Primitives/Torus", priority = 34)]
#endif
