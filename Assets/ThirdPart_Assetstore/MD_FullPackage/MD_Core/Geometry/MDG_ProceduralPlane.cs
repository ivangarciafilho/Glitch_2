...
namespace MDPackage.Geometry
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Geometry/Plane")]
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Primitives/Plane", priority = 1)]
#endif
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Primitives/Quad", priority = 0)]
#endif
