...
namespace MDPackage.Geometry
{
    ...
    /// </summary>
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Geometry/Mesh Paint")]
    public sealed class MDG_MeshPaint : MonoBehaviour, IDMGenericInputTemplate
    {
        ...
        private readonly MD_BackendGenericButton buttonDownBackend = new MD_BackendGenericButton();
        ...
        private void Update()
        {
            buttonDownBackend.SyncButton(InputHook_GenericButtonDown);
            ...
            buttonDownBackend.ResetButton(false);
        }
        ...
        private Vector3 MeshPaint_GetRaycastPosition()
        {
            ...
            if (Physics.Raycast(r, out RaycastHit hit, Mathf.Infinity, paint_TypeRaycast_AllowedLayers))
            {
        ...
        {
            if (!isUp)
                return buttonDownBackend.IsDown;
            else
                return buttonDownBackend.IsUp;
        }
        ...
        private void MeshPaint_CreateNewPaintPattern(string meshName = "PaintingMesh", bool addCollider = true)
        {
            ...
            {
                Material mat = new Material(Utilities.MD_Utilities.Specific.GetProperPipelineDefaultShader());
