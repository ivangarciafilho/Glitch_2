...
namespace MDPackage.Geometry
{
    ...
    /// </summary>
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Geometry/Node-Based/Path Creator")]
    [ExecuteInEditMode]
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Node-Based Editors/Path Creator")]
#endif
        public static MDG_PathCreator CreateGeometry()
        {
            GameObject newPath = new GameObject("Path Creator");
            var p = newPath.AddComponent<MDG_PathCreator>();
#if UNITY_EDITOR
