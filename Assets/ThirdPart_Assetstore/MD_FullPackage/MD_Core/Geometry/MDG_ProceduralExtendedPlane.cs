...
namespace MDPackage.Geometry
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Geometry/Extended Plane")]
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Complex/Plane Extended")]
#endif
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Complex/Plane Extended Angled")]
#endif
