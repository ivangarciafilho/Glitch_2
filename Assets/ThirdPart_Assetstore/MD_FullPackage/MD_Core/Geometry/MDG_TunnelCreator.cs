...
namespace MDPackage.Geometry
{
    ...
    /// </summary>
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Geometry/Node-Based/Tunnel Creator")]
    [ExecuteInEditMode]
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Node-Based Editors/Tunnel Creator")]
#endif
