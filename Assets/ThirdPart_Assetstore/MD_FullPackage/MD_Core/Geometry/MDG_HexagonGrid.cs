...
namespace MDPackage.Geometry
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAG_PATH_NAME + "Geometry/Hexagon Grid")]
    public sealed class MDG_HexagonGrid : MD_GeometryBase
    {
        ...
        [SerializeField] private bool hexaPlanarHexagon = true;
        [SerializeField] private bool hexaRevertTriangles = false;

        public bool IsPlanarHexagon => hexaPlanarHexagon;
        public bool IsTrianglesReverted => hexaRevertTriangles;
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Complex/Hexagon Grid")]
#endif
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Complex/Planar Hexagon")]
#endif
...
#if UNITY_EDITOR
        [MenuItem("GameObject/3D Object" + MD_Debug.PACKAG_PATH_NAME + "Complex/Spatial Hexagon")]
#endif
...
namespace MDPackage_Editor
{
    ...
    public sealed class MD_HexagonGrid_Editor : MD_GeometryBase_Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            MDE_ve();
             if (!hg.updateEveryFrame && !hg.IsPlanarHexagon)
             {
                 MDE_s(5);
