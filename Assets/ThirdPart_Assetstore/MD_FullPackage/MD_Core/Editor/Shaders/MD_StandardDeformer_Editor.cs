...
{
    /// <summary>
    /// Custom material editor for Standard Deformer shader.
    /// This shader editor has been written back in 2014, and will be deprecated in the later package version (v2025+)
    /// </summary>
    public sealed class MD_StandardDeformer_Editor : MD_MaterialEditorUtilities
    {
        ...
        {
            MDE_s();
            MDE_hb("MD Package - Mesh Deformer 2.0 [Obsolete]");
            MDE_s();
            MDE_l("Essentials");
            MDE_v();
