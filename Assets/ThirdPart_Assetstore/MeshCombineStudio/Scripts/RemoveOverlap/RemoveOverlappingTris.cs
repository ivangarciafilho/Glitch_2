...
namespace MeshCombineStudio
{
    static public class RemoveOverlappingTris
    {
        ...
        static public void RemoveOverlap(Transform t, MeshCombineJobManager.MeshCombineJob meshCombineJob, MeshCache.SubMeshCache newMeshCache, ref byte[] vertexIsInsideCollider, string excludeOverlapRemovalTag = null)
        {
            ...
            for (int a = startIndex; a < endIndex; a++)
            {
                ...
                if (!string.IsNullOrEmpty(excludeOverlapRemovalTag) && cachedGO.go.CompareTag(excludeOverlapRemovalTag))
                {
                    continue;
                }
