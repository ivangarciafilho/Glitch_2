...
namespace Chain
{
    ...
    {
        private ChainPointCreator _chainPointCreator = new ();
        private ChainDrawer _chainDrawer = new();
        ...
        public void GenerateChain(Action saveCogs, Cogwheel[] chainRelatedCogs)
        {
            ...
            _chainPointCreator.ExecutePhase(chainGeneratorData, new object[] { chainRelatedCogs });
            links = _chainDrawer.ExecutePhase(chainGeneratorData);
        }
