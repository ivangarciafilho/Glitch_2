...
public class TaskAtlasPlayerController : MonoBehaviour
{
    ...
    {
        //Horizontal movement
        RigidBody.AddForce(new Vector3((Input.GetAxis("Horizontal") * Speed) - RigidBody.linearVelocity.x * Snappiness, 0, 0));
        ...
        if (Input.GetAxisRaw("Fall") > 0.95)
        {
            ...
            RigidBody.linearVelocity = new Vector3(RigidBody.linearVelocity.x, FastFallSpeed * -1, 0);
        ...
        if (Input.GetAxisRaw("Fall") < 0.95 && FastFallFinished == false)
        {
            ...
            RigidBody.linearVelocity = new Vector3(RigidBody.linearVelocity.x, -55, 0);
        }
