...
namespace TypingFXPro
{
    ...
    public class TypingFXProInspectorNote : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (target.name == "DemoScene")
            {
                GUILayout.Space(10);

                EditorGUILayout.LabelField("Typing FX Pro: Ultimate Edition", headerStyle);
                GUILayout.Space(5);
                ...
                EditorGUILayout.LabelField("FOR UPGRADING USERS:", whiteBoldStyle);

                GUILayout.Space(5);

                EditorGUILayout.LabelField(
                   "For a clean and seamless upgrade, please remove the previous version before importing the new one to prevent any potential conflicts.\n\nThis update includes additional effects, and performance improvements.",
                   whiteLabelStyle);
