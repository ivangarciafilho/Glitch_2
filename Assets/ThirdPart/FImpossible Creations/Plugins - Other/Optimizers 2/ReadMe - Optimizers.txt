...
- Added FIMSpace.FOptimizing.IOptimizersDontOptimize interface, to ignore specific components from being added to 'To Optimize List'

v2.2.2.5
- Implemented myOptimizer.AssignOnLODStateChangeAction() to allow calling custom coded actions on lod level change

v2.2.2.4
- Updated assembly definitions packages

v2.2.2.3
- Optimizers will not include 'to optimize list' components which are disabled
